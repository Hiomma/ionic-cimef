...
@Component({
    ...
    templateUrl: './adicionar-categoria-produto.component.html',
    styleUrls: ['./adicionar-categoria-produto.component.scss'],
})
export class AdicionarCategoriaProdutoComponent implements OnInit {
                ...
                buttons: [
                    {
                        text: "OK",
                        handler: () => {
                            this.graphql.graphql(this.query.updateCategoriaProduto(Number(this.categoria.id), { nome: this.nome, ativado: this.ativado })).then(() => {
                ...
                buttons: [
                    {
                        text: "OK",
                        handler: () => {
                            this.graphql.graphql(this.query.setCategoriaProduto({ nome: this.nome, ativado: this.ativado })).then(() => {
                                this.modalController.dismiss();
